...
namespace Core.Utitlities.Helpers
{
    public class FileHelper
    {
        ...
        {
            string path = Environment.CurrentDirectory + @"\wwwroot\Uploads\images"; //Burda yeni dizin =  mevcuttaki dizin + @"\wwwroot\Uploads\images" demiş olduk. Biraz daha türkçeleştirirsem burası WebAPI katmanında wwwroot klasörünün içinde Uplaods klasöründe Images klasörü oluşturur. 
